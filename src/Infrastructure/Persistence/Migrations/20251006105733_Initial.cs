        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhotoGears_Photographers_PhotographerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PortfolioItems_Photographers_PhotographerId",
                        column: x => x.PhotographerId,
                        principalTable: "Photographers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_PortfolioItems_PortfolioItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PortfolioItemId",
                table: "Comments",
                column: "PortfolioItemId");

            migrationBuilder.CreateIndex(
                name: "IX_PhotoGears_PhotographerId",
                table: "PhotoGears",
                column: "PhotographerId");

            migrationBuilder.CreateIndex(
                name: "IX_PortfolioItems_PhotographerId",
